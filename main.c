...
void firstTask(void * parameters)
{
	char *taskInfo = "This is task 1\n";

	/* to avoid compiler warnings*/
	(void)parameters;

	/* delay of 100ms to print the message */
...
void secondTask(void * parameters)
{
	char *taskInfo = "This is task 2\n";

	/* to avoid compiler warnings*/
	(void)parameters;

	/* delay of 500ms to print the message */
...
void createTasks(void)
{
	...
	/* create first task according to the specification given */
	xTaskCreate(firstTask,  "Task1", 1000, NULL, 3, &xHandle);

	/* create second task according to the specification given */
	xTaskCreate(secondTask, "Task2", 100,  NULL, 1, &xHandle);
}
...
int main(void)
{
	...
	/* Function  to create tasks to print corresponding messages */
	createTasks();
